...
public class ShowCustomerMenuList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.accepted), "떡볶이", "12345", "#떡순튀 #매운맛 조절 가능 #떡순튀 #매운맛 조절 가능 #떡순튀\n" +
                "#매운맛 조절 가능 #떡순튀 #매운맛 조절 가능 #떡순튀 #매운맛 조절 가능\n#떡순튀 #매운맛 조절 가능","★4.3","주문횟수 : 33");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mypage), "떡볶이", "100000", "#짜장 #짬뽕","★4.3","주문횟수 : 33");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.img_upload), "떡볶이", "서울시 동작구", "#짜장 #짬뽕","★4.3","주문횟수 : 33");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tteokbokki), "레드 175", "서울시 동작구", "#짜장 #짬뽕","★4.3","주문횟수 : 33");
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.tteokbokki), "레드 175", "서울시 동작구", "#짜장 #짬뽕","★4.3","주문횟수 : 33");
