...
public class MenuListViewOwnerAdapter extends ArrayAdapter {
    // Adapter에 추가된 데이터를 저장하기 위한 ArrayList
    private ArrayList<MenuListViewItem> listViewItemList = new ArrayList<>();

    // ListViewAdapter의 생성자
    public MenuListViewOwnerAdapter(Context context, int resource, ArrayList<MenuListViewItem> listViewItemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.menu_listview_item_owner, parent, false);
        }
